...
MAKECMD         = /Applications/MATLAB_R2019b.app/bin/maci64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL                  = propagatorN
MODULES                = rt_logging.c propagatorN.c propagatorN_capi.c propagatorN_data.c propagatorN_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
MAKEFILE               = propagatorN.mk
MATLAB_ROOT            = /Applications/MATLAB_R2019b.app
ALT_MATLAB_ROOT        = /Applications/MATLAB_R2019b.app
MATLAB_ROOTQ           = \"/Applications/MATLAB_R2019b.app\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /Users/antoniogenova/GIT/NIM-software
...
COMPUTER               = MACI64
BUILDARGS              =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/Applications/MATLAB_R2019b.app" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTGTCONN -DON_TARGET_WAIT_FOR_START=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=10.9"
...
SYSTEM_LIBS         = -L"/Applications/MATLAB_R2019b.app/bin/maci64" -lmwipp -lut -lmx -lmex -lmat -lmwmathutil -lmwslexec_simbridge -lmwsl_fileio -lmwsigstream -lmwsl_AsyncioQueue -lmwsl_services -lmwsdi_raccel -lmwi18n -lmwsl_simtarget_instrumentation -lfixedpoint -lmwslexec_simlog -lm -lpthread -ldl
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/propagatorN \
...
rtiostream_utils.o : /Applications/MATLAB_R2019b.app/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) /Applications/MATLAB_R2019b.app/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
